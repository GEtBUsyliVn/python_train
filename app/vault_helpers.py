...
class VaultHelpers:
    def __init__(self,settings:BaseSettings):
        ...
        self.config_pvt_ket = settings.vault_pvt_key
        self.config_pub_key = settings.vault_pub_key

    def get_private_secret(self):

        r = requests.get(f"{self.config_vault.url}{self.config_vault.version_prefix}{self.config_pvt_ket.path_to_secret}",verify=False,
